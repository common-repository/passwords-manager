...
function pms_add_plugin_page_settings_link( $links ) {
	$links[] = '<a href="' .admin_url( 'admin.php?page=pms_menu&tab=settings' ) .'">' . 'Settings'. '</a>';
	return $links;
}
...
if ( ! function_exists('pms_live_demo_meta_links') ) {
	function pms_live_demo_meta_links($meta_fields, $file) {
		...
		$meta_fields[] = "<a href='" . esc_url($plugin_url) ."' target='_blank' title='" .'Live demo' . "'>
