			...
			<div class="row mb-3">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-end mob-dash"> <?php          			
					if(empty($stng_key)){?> <button type="button" class="btn btn-secondary btn-xs" data-bs-toggle="tooltip"
                            ...
                            class="fa fa-plus-circle fa-2x"></i></button> <?php }else{?> 
								<button type="button" name="add" id="add_user_pass" data-bs-toggle="modal" data-bs-target="#pwdsModal" class="btn btn-primary btn-xs">
