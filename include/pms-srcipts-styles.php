		...
		if(!function_exists('pwdms_add_admin_scripts')  && (sanitize_text_field($_GET['page']) == 'pms_menu')){
			function pwdms_add_admin_scripts() {
				...
				**/
				...
				wp_enqueue_style( PWDMS_NAME.'-owl-carousel-css', PWDMS_ASSETS . 'libs/owl-carousel/css/owl.carousel.min.css',array(),rand()); 
				wp_enqueue_style( PWDMS_NAME.'-owl-carousel-theme', PWDMS_ASSETS . 'libs/owl-carousel/css/owl.theme.default.min.css',array(),rand());
				wp_enqueue_style(PWDMS_NAME . '_admin', PWDMS_ASSETS . 'css/pms-admin.css', array(), rand());
				...
				**/
				...
				wp_enqueue_script( PWDMS_NAME.'-owl-carousel-js', PWDMS_ASSETS . 'libs/owl-carousel/js/owl.carousel.min.js', array(), rand(),true);
